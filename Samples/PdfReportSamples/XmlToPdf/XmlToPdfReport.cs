...
namespace PdfReportSamples.XmlToPdf
{
    public class XmlToPdfReport
    {
        public IPdfReportData CreatePdfReport()
        {
            ...
            {
                dataSource.Xml(File.ReadAllText(System.IO.Path.Combine(AppPath.ApplicationPath, "data\\places.xml")),
            ...
            .Generate(data => data.AsPdfFile(string.Format("{0}\\Pdf\\XmlToPdfSampleData-{1}.pdf", AppPath.ApplicationPath, Guid.NewGuid().ToString("N"))));
        }
    }
}
