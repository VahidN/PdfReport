...
namespace PdfReportSamples.DigitalSignature
{
    public class DigitalSignaturePdfReport
    {
        ...
        public IPdfReportData CreatePdfReport()
        {
            return new PdfReport().DocumentPreferences(doc =>
            {
                ...
                doc.AddFileAttachment(new FileAttachment { FilePath = System.IO.Path.Combine(AppPath.ApplicationPath, "data\\cert123.pfx"), Description = "Test" });
             ...
             .Sign(sign =>
             {
                 sign.WithCertificateFile(appendSignature: true, pfxPassword: "123", pfxPath: System.IO.Path.Combine(AppPath.ApplicationPath, "data\\cert123.pfx"));
             ...
             .Generate(data => data.AsPdfFile(string.Format("{0}\\Pdf\\DigitalSignatureSample-{1}.pdf", AppPath.ApplicationPath, Guid.NewGuid().ToString("N"))));
        }
    }
}
